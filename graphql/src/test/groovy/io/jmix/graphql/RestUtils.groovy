...
class RestUtils {
    ...
    static String getAuthToken(String baseUrl, String login, String password, Map<String, String> headers) throws IOException {
    ...
    static ReadContext parseResponse(CloseableHttpResponse response) throws IOException {
